                            ...
                            @if (isset($bannerEdit))
                                ...
                                <form action="{{ route('banner.update', $bannerEdit->id) }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="e_file" class="form-control" accept="video/*"
                                            onchange="previewFile(event)">
                                        <div class="mt-2">
                                            @php
                                                $ext = pathinfo($bannerEdit->file, PATHINFO_EXTENSION);
                                            @endphp
                                            @if (in_array(strtolower($ext), ['mp4', 'mov', 'avi', 'wmv']))
                                                <video id="file-preview" controls
                                                    style="max-height: 150px; border:1px solid #ccc; padding:5px;">
                                                    <source src="{{ asset('storage/' . $bannerEdit->file) }}"
                                                        type="video/{{ $ext }}">
                                                </video>
                                            @endif
                                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column flex-md-row justify-content-between gap-3 mb-3 mt-3">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <select class="form-select form-select-sm w-auto entriesSelect" data-target="infoTable">
    ...
    <script>
        function previewFile(event) {
            ...
            if (file.type.startsWith('video/')) {
                ...
                alert("Hanya diperbolehkan upload video!");
