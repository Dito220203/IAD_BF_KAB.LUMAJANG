    ...
    <main id="main" class="main">
        ...
        <script>
            ...
            function onMapClick(e) {
                // kalau sudah ada marker, hapus dulu
                if (markers.length > 0) {
                ...
                // tambah marker baru dengan draggable
                markers[index] = L.marker(e.latlng, {
                    draggable: true
                }).addTo(mymap).bindPopup(
                    "<button type='button' class='btn btn-sm btn-danger' onclick='hapusMarker(" + index +
                    ")'>Hapus</button>"
                );

                // buat hidden input
                let html = `<input type="hidden" id="longitude" name="longitude" value="${e.latlng.lng}">
                ...
                // update nilai latitude & longitude ketika marker digeser
                markers[index].on('dragend', function(event) {
