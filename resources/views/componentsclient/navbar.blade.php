{{-- <header id="header"  class="header d-flex align-items-center fixed-top {{ request()->is('/') ? '' : 'header-scrolled' }}">
>
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu">
            <ul>
                    ...
                    <ul>
                        @foreach ($subprograms as $subprogram)
                            <li class="dropdown"><a href="#"><span>{{ $subprogram->subprogram }}</span><i
                                ...
                                <ul>
                                    <li><a href="{{ url('subprogram/' . $subprogram->id . '/tentang') }}">TENTANG
                                            {{ strtoupper($subprogram->subprogram) }}</a></li>
                                    <li><a href="{{ url('subprogram/' . $subprogram->id . '/rencana') }}">RENCANA
                                            KEGIATAN</a></li>
                                    <li><a href="{{ url('subprogram/' . $subprogram->id . '/progres') }}">PROGRES
                                            KEGIATAN</a></li>
                ...
                <li><a href="{{ route('client.regulasi') }}">REGULASI IAD</a></li>
                <li><a href="#videosection">VIDEO</a></li>
                <li><a href="#contact">CONTACT</a></li>
                <li><a href="login">SING IN</li>
            </ul>
        </nav>
