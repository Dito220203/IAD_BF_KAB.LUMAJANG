    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu">
            <ul>
                ...
                <li class="dropdown {{ request()->segment(1) == 'subprogram' ? 'active' : '' }}"><a href="#"><span>PROGRAM IAD</span> <i
                ...
                <li class="dropdown">
                    <a href="{{ route('profilkawasan.search') }}"
                        class="{{ request()->is('profil-kawasan*') || request()->is('profil*') ? 'active' : '' }}">
