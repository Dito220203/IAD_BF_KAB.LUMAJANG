                ...
                <li class="dropdown"><a href="#"><span>PROGRAM IAD</span> <i
                    ...
                    <ul>
                        <li class="dropdown"><a href="#"><span>AGROINDUSTRI</span><i
                            ...
                            <ul>
                                <li><a href="{{ route('client.tentangkegiatan') }}"
                                        class="{{ request()->is('tentangkegiatan') ? 'active' : '' }}">TENTANG
                                        AGROINDUSTRI</a></li>
                                <li><a href="{{ route('client.rencanakegiatan') }}"
                                        class="{{ request()->is('rencanakegiatan') ? 'active' : '' }}">RENCANA
                                        KEGIATAN</a></li>
                                <li><a href="{{ route('client.progreskegiatan') }}"
                                        class="{{ request()->is('progreskegiatan') ? 'active' : '' }}">PROGRES
                                        KEGIATAN</a></li>
                                <li><a href="{{ route('client.monev') }}"
                                        class="{{ request()->is('monev') ? 'active' : '' }}">MONITORING & EVALUASI</a>
                                </li>
                                <li><a href="{{ route('client.petasebarankegiatan') }}"
                                        class="{{ request()->is('petasebarankegiatan') ? 'active' : '' }}">PETA
                                        SEBARAN</a></li>
                            </ul>
                        </li>
